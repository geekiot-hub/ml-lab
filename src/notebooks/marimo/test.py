...
def _():
    ...
    return ListedColormap, SVC, StandardScaler, load_iris, mo, np, plt
...
def _(mo):
    ...
    return (gamma_value_slider,)


@app.cell(hide_code=True)
def _(gamma_value_slider, mo):
    mo.md(f"""
...
@app.cell
def _(X_std, plot_decision_regions, plt, svm, y):
